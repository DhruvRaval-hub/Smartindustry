...
const char* ssid     = "dhruv nu 6";
const char* password = "dhruv@290";
...
//  String url3 = "/authentication/flameapi.php?flame=" + String(flame_value);
  String url = "/authentication/smoke.php?smokevalue=" + String(smoke_value);
...
//  String url9 = "/authentication/rfid.php?rfidvalue=" + String(rfidvalue);
